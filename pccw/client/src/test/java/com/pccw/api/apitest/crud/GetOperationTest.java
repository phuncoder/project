...
public class GetOperationTest {
    ...
    static class OperationImplTestContextConfiguration {
        ...
        public IHttpOperation getOperation() {
	...
	public void testgetOperation() {
		...
		when(restTemplate.exchange(request.getUrl(), HttpMethod.GET, requestEntity, String.class)).thenReturn(response);
